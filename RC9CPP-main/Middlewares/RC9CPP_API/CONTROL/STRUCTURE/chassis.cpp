...
{
	//	//采用接收的ros数据进行点追踪，转换单位为mm
    float dis_vector_x = 1000*ROS->nextpoint[0];
    float dis_vector_y = 1000*ROS->nextpoint[1];
//	float dis_vector_x = 1000.0f;
//    float dis_vector_y = 1000.0f;

    point_track_info.distan_error = sqrt(dis_vector_x*dis_vector_x +dis_vector_y*dis_vector_y);
