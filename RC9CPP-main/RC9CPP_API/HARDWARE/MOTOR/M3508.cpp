 ...
 ******************************************************************************/
#include "M3508.h"
m3508p::m3508p(uint8_t can_id, CAN_HandleTypeDef *hcan_, uint8_t gear_ratio, float kp_, float ki_, float kd_) : CanDevice(M3508, hcan_, can_id), gear_ratio(gear_ratio), pid(kp_, ki_, kd_, 1000000.0f, 20000.0f, 0.01f, 960.0f), dji_motor(20000.0f, 16384, 8191) // 选择使用积分分离的话积分限幅就是无意义的，随便给个爆大的值就行
{
}
